...
import { Save, Settings, Code, History, Monitor, Lock, RefreshCw, ChevronDown, ChevronUp } from 'lucide-react'
  ...
  return (
    <div className='w-full max-w-6xl mx-auto space-y-8 pb-20'>
      ...
      <div className='grid grid-cols-1 lg:grid-cols-2 gap-6'>
        <div className='bg-white p-6 rounded-2xl border shadow-sm space-y-4'>
          ...
          <div className='flex gap-2'>
            <input type="text" value={logoInternoNome} onChange={(e)=>setLogoInternoNome(e.target.value)} placeholder="ex: logo.png" className='flex-1 p-2 border rounded-lg' />
        ...
        <div className='bg-white p-6 rounded-2xl border shadow-sm space-y-4'>
          ...
          <div className='flex gap-2'>
            <input type="text" value={logoLoginNome} onChange={(e)=>setLogoLoginNome(e.target.value)} placeholder="ex: logo-login.png" className='flex-1 p-2 border rounded-lg' />
      ...
      <div className='flex justify-center'>
        <button onClick={() => window.location.reload()} className='flex items-center gap-2 bg-gray-100 p-3 rounded-lg font-bold'><RefreshCw size={20} /> Atualizar Sistema</button>
      </div>
