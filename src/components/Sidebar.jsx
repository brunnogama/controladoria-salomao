  ...
  return (
    <>
      ...
      <button 
        ...
        className="md:hidden fixed top-4 left-4 z-[60] p-2 bg-[#0F2C4C] text-white rounded-lg shadow-lg"
      >
      ...
      `}>
        ...
        <nav className="flex-1 px-4 py-6 space-y-2 overflow-y-auto">
          {menuItems.map(item => (
            <Link key={item.path} to={item.path} className={isActive(item.path)} onClick={() => setIsOpen(false)}>
